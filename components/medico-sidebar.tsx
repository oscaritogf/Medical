...
import { LayoutDashboard, Calendar, Clock, Users, Settings, LogOut, Activity } from "lucide-react"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium truncate">
              Dr. {user?.persona.nombre} {user?.persona.apellido}
            </p>
            <p className="text-xs text-muted-foreground">{user?.medico?.especialidad?.nombre}</p>
          </div>
        </div>
      </div>
